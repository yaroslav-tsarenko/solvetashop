  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <BarChart data={last7}>
        ...
        <Bar yAxisId="left" dataKey="orders" fill="#26618F" radius={[6, 6, 0, 0]} name="Orders" />
        <Bar yAxisId="right" dataKey="revenue" fill="rgba(38, 97, 143,0.4)" radius={[6, 6, 0, 0]} name="Revenue (£)" />
      </BarChart>
    </ResponsiveContainer>
  );
}
