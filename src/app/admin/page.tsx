...
export default function AdminDashboard() {
  ...
  const kpis = [
    ...
    { label: "Today's Orders", value: String(data.todayOrders), icon: <ShoppingCart size={18} />, bg: "rgba(38, 97, 143,0.12)", fg: "#26618F", change: pct(data.todayOrders, data.yesterdayOrders), sub: `vs ${data.yesterdayOrders} yesterday` },
    { label: "Total Products", value: String(data.totalProducts), icon: <Package size={18} />, bg: "rgba(176, 131, 71,0.12)", fg: "#B08347", sub: `${data.stockDistribution.lowStock} low stock` },
    { label: "Total Customers", value: String(data.totalCustomers), icon: <Users size={18} />, bg: "rgba(74, 133, 179,0.12)", fg: "#4A85B3", sub: `${data.totalOrders} total orders` },
  ];
