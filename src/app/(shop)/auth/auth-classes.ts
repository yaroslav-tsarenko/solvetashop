...
export const authClasses = {
  authPage:
    "relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-8 [background:linear-gradient(135deg,#EEF4F9_0%,#FAF3E9_30%,#FAFAF9_70%,#F5F5F4_100%)] before:pointer-events-none before:absolute before:-left-1/2 before:-top-1/2 before:h-[200%] before:w-[200%] before:content-[''] before:[background:radial-gradient(circle_at_30%_20%,rgba(38, 97, 143,0.08)_0%,transparent_50%),radial-gradient(circle_at_70%_80%,rgba(176, 131, 71,0.06)_0%,transparent_50%)] dark:[background:linear-gradient(135deg,#1A1D21_0%,#1C1917_30%,#292524_70%,#1A1D21_100%)] dark:before:[background:radial-gradient(circle_at_30%_20%,rgba(74, 133, 179,0.06)_0%,transparent_50%),radial-gradient(circle_at_70%_80%,rgba(193, 149, 79,0.05)_0%,transparent_50%)]",
