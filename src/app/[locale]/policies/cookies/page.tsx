...
export const metadata = { title: "Cookie Policy — Solvetashop" };

export default function CookiePolicyPage() {
  return (
    <PolicyLayout title="Cookie Policy" lastUpdated="29 May 2026">
      <p>
        This Cookie Policy explains how {COMPANY.legalName}, trading as Solvetashop, uses cookies and similar
        technologies on www.solvetashop.com.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Cookie Policy, &ldquo;Solvetashop&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
        &ldquo;our&rdquo; means {COMPANY.legalName}. &ldquo;You&rdquo; or &ldquo;your&rdquo; means any visitor,
      ...
      <ul>
        <li>first-party cookies, set directly by Solvetashop; or</li>
      ...
      <p>
        8.2 These cookies may be set by Solvetashop or by third-party advertising and marketing partners.
      </p>
      <p>
      ...
      <p>9.4 Solvetashop does not store your full card number or full card security code.</p>
