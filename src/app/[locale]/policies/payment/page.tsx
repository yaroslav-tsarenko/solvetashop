...
export const metadata = { title: "Payment Policy — Solvetashop" };
  ...
  return (
    <PolicyLayout title="Payment Policy" lastUpdated="29 May 2026">
      <p>
        ...
        for purchases made through www.solvetashop.com.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Policy, &ldquo;Solvetashop&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or &ldquo;our&rdquo;
        means {COMPANY.legalName}. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or &ldquo;your&rdquo; means any
      ...
      <p>
        1.2 Solvetashop sells electrical products, electrical materials, wiring accessories, lighting-related
      ...
      <p>
        2.5 Solvetashop does not control exchange rates, bank conversion fees, card issuer charges, or foreign
        transaction fees.
      </p>
      ...
      <p>
        3.4 Price changes will not affect orders already accepted by Solvetashop, except where there has been
      ...
      <p>4.1 Solvetashop accepts secure card payments using:</p>
      <ul>
        <li>Visa</li>
        <li>Mastercard</li>
      </ul>
      ...
      <p>
        5.3 Solvetashop does not guarantee that your payment will be accepted. Payment approval depends on
      ...
      <p>6.1 Solvetashop takes payment security seriously.</p>
      <p>
        6.2 Card payments are handled through secure third-party payment providers. Solvetashop does not store
      ...
      <p>
        8.2 Solvetashop is not responsible for payment failures caused by your bank, card issuer, payment
      ...
      <p>
        9.1 To protect customers, Solvetashop, payment providers, and card networks, transactions may be
      ...
      <p>
        10.3 Where applicable, Solvetashop may issue order confirmations, payment confirmations, receipts, VAT
      ...
      <p>12.1 Solvetashop dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        ...
        in the product price, delivery price, or payment collected by Solvetashop.
      </p>
      <p>
      ...
      <p>
        12.5 Solvetashop does not control customs authorities, customs delays, import tax assessments, courier
      ...
      <p>
        ...
        is required by law or approved by Solvetashop, the related Additional Warranty charge may also be
        refunded.
      </p>
      ...
      <p>
        ...
        are not controlled by Solvetashop and are not refundable by Solvetashop.
      </p>
      <p>
        15.6 Customs duties, import VAT, local taxes, brokerage fees, courier handling fees, customs
        clearance fees, and other local charges are not charged by Solvetashop and are not refundable by
        Solvetashop.
      </p>
      ...
      <p>
        ...
        should contact us first at info@solvetashop.com so we can investigate and try to resolve the issue.
      </p>
      <p>
      ...
      <p>
        17.2 Solvetashop does not offer credit terms, open account purchasing, or deferred payment to Business
